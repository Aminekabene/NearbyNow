    ...
    useEffect(() => {
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition( (position) => {
                ...
                axios({
                    method: "get",
                    url: "https://api.geoapify.com/v2/places?categories=catering,commercial,accommodation,education,childcare,entertainment,healthcare,rental,service,amenity,ski,activity&filter=circle:-73.57769911783691,45.495842959494865,300&bias=proximity:"+long+","+lat+"&limit=500&apiKey=5e429380f4264430a6330e5eff59a505"
                }).then(res => {
                    setInterval(() => {
        ...
        canvas.toBlob((blob) => {
            ...
            reader.onloadend = function() {
                ...
                axios({
                    ...
                    params: {
                        "key":"AIzaSyBvBp4vm5ghLX3pY2rBFgFAbQZOjKHsrkA"
                    }                  
                }).then(res => {
